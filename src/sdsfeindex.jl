...
# ============ Giannini 2025 (GI) 系列 ============
function jlmsbcgih0(y::Union{Vector,Matrix}, x::Matrix, Q::Matrix, Q_lag::Matrix,
    Wy::Matrix, PorC::Int64, pos::NamedTuple, rho::Array{Float64,1},
    ...
    jlms1 = zeros(eltype(y), size(hi_cur, 1), 1)
    ...
    @inbounds for iidd = 1:ID
        ...
        @views jlms1[ind] = hi_cur[ind] .* eu
    end

    # Apply spatial multiplier (I-λW)⁻¹ per Giannini (2025) Eq. 6
    N = ID
    @views Mgamma = (I(N) - gamma*Wy[1])\I(N)
    @views Mgammat = kron(Mgamma, I(T_fd))
    jlms          = Mgammat * jlms1
...
function jlmsbcgihe0(y::Union{Vector,Matrix}, x::Matrix, Q::Matrix, Q_lag::Matrix,
    EN, IV, Wy::Matrix, PorC::Int64, num::NamedTuple, pos::NamedTuple,
    rho::Array{Float64,1}, eigvalu::NamedTuple, rowIDT::Matrix{Any})
...
function jlmsbcgit0(y::Union{Vector,Matrix}, x::Matrix, Q::Matrix, Q_lag::Matrix,
    Wy::Matrix, PorC::Int64, pos::NamedTuple, rho::Array{Float64,1},
    eigvalu::NamedTuple, rowIDT::Matrix{Any})
...
function jlmsbcgite0(y::Union{Vector,Matrix}, x::Matrix, Q::Matrix, Q_lag::Matrix,
    EN, IV, Wy::Matrix, PorC::Int64, num::NamedTuple, pos::NamedTuple,
    rho::Array{Float64,1}, eigvalu::NamedTuple, rowIDT::Matrix{Any})
...
#* --- jlmsbc0 dispatches for Giannini 2025 ---
...
#* --- jlmsbc dispatches (with direct/indirect) for Giannini 2025 ---

function jlmsbc(::Type{SSFGIH}, y::Union{Vector,Matrix}, x::Matrix, Q::Matrix, w::Matrix, v::Matrix, z, EN, IV,
    PorC::Int64, num::NamedTuple, pos::NamedTuple, rho::Array{Float64,1}, eigvalu::NamedTuple, rowIDT::Matrix{Any})
    Wy = _dicM[:wy];  Q_lag = _dicM[:qvar_lag]
    jlms, jlms_direct, jlms_indirect = jlmsbcgih0(y, x, Q, Q_lag, Wy, PorC, pos, rho, eigvalu, rowIDT)
    return jlms, jlms_direct, jlms_indirect
end

function jlmsbc(::Type{SSFGIEH}, y::Union{Vector,Matrix}, x::Matrix, Q::Matrix, w::Matrix, v::Matrix, z, EN, IV,
    PorC::Int64, num::NamedTuple, pos::NamedTuple, rho::Array{Float64,1}, eigvalu::NamedTuple, rowIDT::Matrix{Any})
    Wy = _dicM[:wy];  Q_lag = _dicM[:qvar_lag]
    jlms, jlms_direct, jlms_indirect = jlmsbcgihe0(y, x, Q, Q_lag, EN, IV, Wy, PorC, num, pos, rho, eigvalu, rowIDT)
    return jlms, jlms_direct, jlms_indirect
end

function jlmsbc(::Type{SSFGIT}, y::Union{Vector,Matrix}, x::Matrix, Q::Matrix, w::Matrix, v::Matrix, z, EN, IV,
    PorC::Int64, num::NamedTuple, pos::NamedTuple, rho::Array{Float64,1}, eigvalu::NamedTuple, rowIDT::Matrix{Any})
    Wy = _dicM[:wy];  Q_lag = _dicM[:qvar_lag]
    jlms, jlms_direct, jlms_indirect = jlmsbcgit0(y, x, Q, Q_lag, Wy, PorC, pos, rho, eigvalu, rowIDT)
    return jlms, jlms_direct, jlms_indirect
end

function jlmsbc(::Type{SSFGIET}, y::Union{Vector,Matrix}, x::Matrix, Q::Matrix, w::Matrix, v::Matrix, z, EN, IV,
    PorC::Int64, num::NamedTuple, pos::NamedTuple, rho::Array{Float64,1}, eigvalu::NamedTuple, rowIDT::Matrix{Any})
    Wy = _dicM[:wy];  Q_lag = _dicM[:qvar_lag]
